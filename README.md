...
107 tests covering the privacy classifier, tagger, database layer, scanner matching, Flickr client retry/jitter/4xx handling, batch person actions, schema migrations, reconcile exit codes, and the `bp` CLI entry point.
